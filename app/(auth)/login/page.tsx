...
export default async function LoginPage({
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-gradient-to-br from-sky-50 via-white to-sky-100 px-6 py-12 text-sky-900">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.22),_transparent_60%),radial-gradient(circle_at_bottom,_rgba(125,211,252,0.25),_transparent_55%)]" />
      <div className="w-full max-w-md space-y-8">
        <div className="space-y-4 text-center">
          <p className="text-xs uppercase tracking-[0.4em] text-sky-600">JBV Capital</p>
          <h1 className="text-3xl font-semibold text-sky-900 sm:text-4xl">Investor portal access</h1>
        ...
        <div className="rounded-xl border border-sky-100 bg-white/80 p-8 shadow-xl shadow-sky-200/60 backdrop-blur">
          <LoginForm />
        </div>
